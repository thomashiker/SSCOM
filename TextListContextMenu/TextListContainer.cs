...
{
    public partial class TextListContainer : ToolStripDropDown
    {
        ...
        private TextListContextMenu contextMenu;//new PortSettingMenu();


        public TextListContainer()
        {
            contextMenu = new TextListContextMenu(this);
            InitializeComponent();
        ...
        {
            contextMenu.MyListBox.Items.Add(item);
        }
        ...
        public void Show(TextBox tb)
        {
            ...
            contextMenu.Width = tb.Width;
            contextMenu.MyTextBox = tb;
            Show(tb, tb.ClientRectangle);
        }
